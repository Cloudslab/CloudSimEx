...
public class GeoDistanceCacheKey {
    ...
    private static boolean areEqualCoords(double lat1_1, double lon1_1, double lat1_2, double lon1_2,
	    double lat2_1, double lon2_1, double lat2_2, double lon2_2) {
	boolean match = lat1_1 == lat2_1 &&
		lon1_1 == lon2_1 &&
		lat1_2 == lat2_2 &&
		lon1_2 == lon2_2;
	boolean matchInverse = !match &&
		lat1_1 == lat2_2 &&
		lon1_1 == lon2_2 &&
		lat1_2 == lat2_1 &&
		lon1_2 == lon2_1;
