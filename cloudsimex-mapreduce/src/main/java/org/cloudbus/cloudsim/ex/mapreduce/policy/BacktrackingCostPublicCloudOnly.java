...
public class BacktrackingCostPublicCloudOnly extends Policy {

	@Override
	public Boolean runAlgorithm(Cloud cloud, Request request) {
		Backtracking backtracking = new Backtracking();
		return backtracking.runAlgorithm(cloud, request, BacktrackingSorts.Cost, CloudDeploymentModel.Public);
	}
}
