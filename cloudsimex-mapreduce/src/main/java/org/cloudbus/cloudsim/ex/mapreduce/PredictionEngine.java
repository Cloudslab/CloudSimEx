...
public class PredictionEngine
{
	 ...
	 */
	public static double[] predictExecutionTimeAndCostFromScheduleingPlan(Map<Integer, Integer> schedulingPlanInput, List<VmInstance> nVMs, Job job)
	{
		
		ArrayList<ArrayList<VmInstance>> provisioningPlans = Request.getProvisioningPlan(schedulingPlanInput, nVMs, job);
