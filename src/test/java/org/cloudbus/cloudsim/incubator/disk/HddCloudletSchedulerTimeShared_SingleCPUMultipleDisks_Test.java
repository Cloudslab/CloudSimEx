...
public class HddCloudletSchedulerTimeShared_SingleCPUMultipleDisks_Test {
	...
	ImmutableMap<String, Integer> cloudletExpectedStatus = ImmutableMap.<String, Integer> builder()
		.put("cloudlet1", Cloudlet.SUCCESS)
		.put("cloudlet2", Cloudlet.SUCCESS)
		.put("cloudlet3", Cloudlet.SUCCESS)
		.put("cloudlet4", Cloudlet.SUCCESS).build();
	ImmutableMap<String, Double> cloudletExpectedExecTimes = ImmutableMap.<String, Double> builder()
		.put("cloudlet1", 3.0)
		.put("cloudlet2", 3.0)
		.put("cloudlet3", 3.0)
		.put("cloudlet4", 3.0).build();
	...
	ImmutableMap<String, DataItem> cloudletsToDataItems = ImmutableMap.<String, DataItem> builder()
		.put("cloudlet1", dataItem_1_1)
		.put("cloudlet2", dataItem_2_1)
		.put("cloudlet3", dataItem_1_2)
		.put("cloudlet4", dataItem_2_2).build();
	...
	ImmutableMap<String, Integer> cloudletExpectedStatus = ImmutableMap.<String, Integer> builder()
		.put("cloudlet1", Cloudlet.SUCCESS)
		.put("cloudlet2", Cloudlet.FAILED)
		.put("cloudlet3", Cloudlet.SUCCESS)
		.put("cloudlet4", Cloudlet.FAILED).build();
	ImmutableMap<String, Double> cloudletExpectedExecTimes = ImmutableMap.<String, Double> builder()
		.put("cloudlet1", 1.0)
		.put("cloudlet2", -1.0)
		.put("cloudlet3", 1.0)
		.put("cloudlet4", -1.0).build();
	...
	cloudlet1 = new WebCloudlet(0, lengths[0], lengths[1], 5, broker.getId(), cloudLetIdsToDiskIds.get("cloudlet1"));
	cloudlet1.setVmId(vm1.getId());

	lengths = cloudletsLength.get("cloudlet2");
	cloudlet2 = new WebCloudlet(0, lengths[0], lengths[1], 5, broker.getId(), cloudLetIdsToDiskIds.get("cloudlet2"));
	cloudlet2.setVmId(vm1.getId());

	lengths = cloudletsLength.get("cloudlet3");
	cloudlet3 = new WebCloudlet(0, lengths[0], lengths[1], 5, broker.getId(), cloudLetIdsToDiskIds.get("cloudlet3"));
	cloudlet3.setVmId(vm2.getId());

	lengths = cloudletsLength.get("cloudlet4");
	cloudlet4 = new WebCloudlet(0, lengths[0], lengths[1], 5, broker.getId(), cloudLetIdsToDiskIds.get("cloudlet4"));
