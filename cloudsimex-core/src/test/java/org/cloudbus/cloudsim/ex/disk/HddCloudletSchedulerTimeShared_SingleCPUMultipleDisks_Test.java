...
public class HddCloudletSchedulerTimeShared_SingleCPUMultipleDisks_Test {
    ...
    public void testTwoCloudletsPerVmsOnDifferentDisks() {
        ...
        ImmutableMap<String, Integer[]> vmsToDisks = ImmutableMap.<String, Integer[]> builder().put("vm1", new Integer[] { disk1.getId() })
                .put("vm2", new Integer[] { disk2.getId() }).build();

        // the cloudlets refer to the data on the disks of their VM
        ImmutableMap<String, DataItem> cloudletsToDataItems = ImmutableMap.<String, DataItem> builder().put("cloudlet1", dataItem_1_1)
                .put("cloudlet2", dataItem_1_2).put("cloudlet3", dataItem_2_1).put("cloudlet4", dataItem_2_2).build();
        ...
        ImmutableMap<String, Integer[]> cloudletsLength = ImmutableMap.<String, Integer[]> builder()
                .put("cloudlet1", new Integer[] { 1 * VM_MIPS, 2 * HOST_MIOPS }).put("cloudlet2", new Integer[] { 2 * VM_MIPS, 1 * HOST_MIOPS })
                .put("cloudlet3", new Integer[] { 1 * VM_MIPS, 2 * HOST_MIOPS }).put("cloudlet4", new Integer[] { 2 * VM_MIPS, 1 * HOST_MIOPS }).build();

        provisionVMsAndScheduleCloudlets(vmsToDisks, cloudletsToDataItems, cloudletsLength);

        // the expected results from the test
        ImmutableMap<String, Integer> cloudletExpectedStatus = ImmutableMap.<String, Integer> builder().put("cloudlet1", Cloudlet.SUCCESS)
                .put("cloudlet2", Cloudlet.SUCCESS).put("cloudlet3", Cloudlet.SUCCESS).put("cloudlet4", Cloudlet.SUCCESS).build();
        ImmutableMap<String, Double> cloudletExpectedExecTimes = ImmutableMap.<String, Double> builder().put("cloudlet1", 3.0).put("cloudlet2", 3.0)
                .put("cloudlet3", 3.0).put("cloudlet4", 3.0).build();
    ...
    public void testTwoCloudletsPerVmsOnOneDisk() {
        ...
        ImmutableMap<String, DataItem> cloudletsToDataItems = ImmutableMap.<String, DataItem> builder().put("cloudlet1", dataItem_1_1)
                .put("cloudlet2", dataItem_1_2).put("cloudlet3", dataItem_1_1).put("cloudlet4", dataItem_1_2).build();
        ...
        ImmutableMap<String, Integer> cloudletExpectedStatus = ImmutableMap.<String, Integer> builder().put("cloudlet1", Cloudlet.SUCCESS)
                .put("cloudlet2", Cloudlet.SUCCESS).put("cloudlet3", Cloudlet.SUCCESS).put("cloudlet4", Cloudlet.SUCCESS).build();
        ImmutableMap<String, Double> cloudletExpectedExecTimes = ImmutableMap.<String, Double> builder().put("cloudlet1", 6.0).put("cloudlet2", 4.0)
                .put("cloudlet3", 6.0).put("cloudlet4", 4.0).build();
    ...
    public void testTwoVmsSharingBothDisks() {
        ...
        ImmutableMap<String, Integer[]> vmsToDisks = ImmutableMap.<String, Integer[]> builder().put("vm1", new Integer[] { disk1.getId(), disk2.getId() })
                .put("vm2", new Integer[] { disk1.getId(), disk2.getId() }).build();

        // the cloudlets refer to data on the disk, which hosts the VMs
        ImmutableMap<String, DataItem> cloudletsToDataItems = ImmutableMap.<String, DataItem> builder().put("cloudlet1", dataItem_1_1)
                .put("cloudlet2", dataItem_2_1).put("cloudlet3", dataItem_1_2).put("cloudlet4", dataItem_2_2).build();

        // the lengths of the cloiudlets in terms of CPU and IO
        ImmutableMap<String, Integer[]> cloudletsLength = ImmutableMap.<String, Integer[]> builder()
                .put("cloudlet1", new Integer[] { 1 * VM_MIPS, 2 * HOST_MIOPS }).put("cloudlet2", new Integer[] { 2 * VM_MIPS, 1 * HOST_MIOPS })
                .put("cloudlet3", new Integer[] { 2 * VM_MIPS, 4 * HOST_MIOPS }).put("cloudlet4", new Integer[] { 4 * VM_MIPS, 2 * HOST_MIOPS }).build();
        ...
        ImmutableMap<String, Integer> cloudletExpectedStatus = ImmutableMap.<String, Integer> builder().put("cloudlet1", Cloudlet.SUCCESS)
                .put("cloudlet2", Cloudlet.SUCCESS).put("cloudlet3", Cloudlet.SUCCESS).put("cloudlet4", Cloudlet.SUCCESS).build();
        ImmutableMap<String, Double> cloudletExpectedExecTimes = ImmutableMap.<String, Double> builder().put("cloudlet1", 4.0).put("cloudlet2", 3.0)
                .put("cloudlet3", 8.0).put("cloudlet4", 6.0).build();
    ...
    public void testCloudletsWithoutAccessToData() {
        ...
        // the respective VMs
        ImmutableMap<String, DataItem> cloudletsToDataItems = ImmutableMap.<String, DataItem> builder().put("cloudlet1", dataItem_1_1)
                .put("cloudlet2", dataItem_2_1).put("cloudlet3", dataItem_2_2).put("cloudlet4", dataItem_1_2).build();

        // the lengths of the cloiudlets in terms of CPU and IO
        ImmutableMap<String, Integer[]> cloudletsLength = ImmutableMap.<String, Integer[]> builder()
                .put("cloudlet1", new Integer[] { 1 * VM_MIPS, 1 * HOST_MIOPS }).put("cloudlet2", new Integer[] { 20 * VM_MIPS, 100 * HOST_MIOPS })
                .put("cloudlet3", new Integer[] { 1 * VM_MIPS, 1 * HOST_MIOPS }).put("cloudlet4", new Integer[] { 40 * VM_MIPS, 200 * HOST_MIOPS }).build();

        provisionVMsAndScheduleCloudlets(vmsToDisks, cloudletsToDataItems, cloudletsLength);

        // the expected results from the test
        ImmutableMap<String, Integer> cloudletExpectedStatus = ImmutableMap.<String, Integer> builder().put("cloudlet1", Cloudlet.SUCCESS)
                .put("cloudlet2", Cloudlet.FAILED).put("cloudlet3", Cloudlet.SUCCESS).put("cloudlet4", Cloudlet.FAILED).build();
        ImmutableMap<String, Double> cloudletExpectedExecTimes = ImmutableMap.<String, Double> builder().put("cloudlet1", 1.0).put("cloudlet2", -1.0)
                .put("cloudlet3", 1.0).put("cloudlet4", -1.0).build();
    ...
    private void runtTestAndValidateResults(final ImmutableMap<String, Integer> cloudletExpectedStatus,
        ...
        double cloudletExecTime1 = cloudlet1.getCloudletStatus() == Cloudlet.SUCCESS ? cloudlet1.getFinishTime() - cloudlet1.getExecStartTime() : -1;
        double cloudletExecTime2 = cloudlet2.getCloudletStatus() == Cloudlet.SUCCESS ? cloudlet2.getFinishTime() - cloudlet2.getExecStartTime() : -1;
        double cloudletExecTime3 = cloudlet3.getCloudletStatus() == Cloudlet.SUCCESS ? cloudlet3.getFinishTime() - cloudlet3.getExecStartTime() : -1;
        double cloudletExecTime4 = cloudlet4.getCloudletStatus() == Cloudlet.SUCCESS ? cloudlet4.getFinishTime() - cloudlet4.getExecStartTime() : -1;
    ...
    private void provisionVMsAndScheduleCloudlets(final ImmutableMap<String, Integer[]> vmIdsToDiskIds,
            final ImmutableMap<String, DataItem> cloudLetIdsToDiskIds, final ImmutableMap<String, Integer[]> cloudletsLength) {
