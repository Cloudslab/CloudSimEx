...
public class ExampleGaussianDelaysPerType {
     ...
     * by Mao and Humphrey.
     */
    public static Map<Pair<String, String>, Pair<Double, Double>> EC2_BOOT_TIMES = ImmutableMap.<Pair<String, String>, Pair<Double, Double>> builder()
            // === Standard On-Demand Instances
            .put(of("m1.small", NIX_OS), of(100.0, 5.0)).put(of("m1.medium", NIX_OS), of(100.0, 5.0)).put(of("m1.large", NIX_OS), of(100.0, 10.0))
            ...
            .put(of("m2.xlarge", NIX_OS), of(110.0, 5.0)).put(of("m2.2xlarge", NIX_OS), of(110.0, 5.0)).put(of("m2.4xlarge", NIX_OS), of(110.0, 5.0))
