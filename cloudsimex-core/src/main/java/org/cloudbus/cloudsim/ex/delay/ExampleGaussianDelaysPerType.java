...
public class ExampleGaussianDelaysPerType {
     ...
     * by Mao and Humphrey.
     */
    public static Map<Pair<String, String>, Pair<Double, Double>> EC2_BOOT_TIMES =
	    ImmutableMap.<Pair<String, String>, Pair<Double, Double>> builder()
		    ...
		    .put(of("m2.xlarge", NIX_OS), of(110.0, 5.0))
		    .put(of("m2.2xlarge", NIX_OS), of(110.0, 5.0))
		    .put(of("m2.4xlarge", NIX_OS), of(110.0, 5.0))

		    // === High-CPU On-Demand Instances
		    .put(of("c1.medium", NIX_OS), of(90.0, 2.0))
		    .put(of("c1.xlarge", NIX_OS), of(90.0, 2.0))
		    ...
		    // === Wildcards
		    .put(of((String) null, NIX_OS), of(96.9, 10.0))
		    .put(of((String) null, WINDOWS), of(810.2, 10.0))
		    .build();
